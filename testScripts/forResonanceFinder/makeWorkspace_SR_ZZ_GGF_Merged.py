...
if __name__ == "__main__":
  ...
  if use0L:
    if useSR: 
      if useMerg:
        regions["L0_MergHP_GGF_WZ_SR"]=[useData, "Pass_MergHP_GGF_WZ_SR", findBinning("L0_MergHP_GGF_WZ_SR",usePNN), "X_boosted_m", "weight"]
        regions["L0_MergLP_GGF_WZ_SR"]=[useData, "Pass_MergLP_GGF_WZ_SR", findBinning("L0_MergLP_GGF_WZ_SR",usePNN), "X_boosted_m", "weight"]
  if use1L:
    if useSR: 
      if useMerg:
        regions["L1_MergHP_GGF_WZ_Untag_SR"]=[useData, "Pass_MergHP_GGF_WZ_Untag_SR", findBinning("L1_MergHP_GGF_WZ_SR",usePNN), "X_boosted_m", "weight"]
        regions["L1_MergHP_GGF_WZ_Tag_SR"]=[useData, "Pass_MergHP_GGF_WZ_Untag_SR", findBinning("L1_MergHP_GGF_WZ_SR",usePNN), "X_boosted_m", "weight"]
        regions["L1_MergLP_GGF_WZ_Untag_SR"]=[useData, "Pass_MergLP_GGF_WZ_Untag_SR", findBinning("L1_MergLP_GGF_WZ_SR",usePNN), "X_boosted_m", "weight"]
        regions["L1_MergLP_GGF_WZ_Tag_SR"]=[useData, "Pass_MergLP_GGF_WZ_Untag_SR", findBinning("L1_MergLP_GGF_WZ_SR",usePNN), "X_boosted_m", "weight"]
      if useRes:
        regions["L1_Resolved_GGF_WZ_Untag_SR"]=[useData, "Pass_Resolved_GGF_WZ_Untag_SR", findBinning("L1_Resolved_GGF_WZ_SR",usePNN), "X_resolved_WZ_m", "weight"]
        regions["L1_Resolved_GGF_WZ_Tag_SR"]=[useData, "Pass_Resolved_GGF_WZ_Untag_SR", findBinning("L1_Resolved_GGF_WZ_SR",usePNN), "X_resolved_WZ_m", "weight"]
    if useTCR:
      if useMerg:
        regins["L1_MergHP_GGF_WZ_Untag_TCR"]=[useData, "Pass_MergHP_GGF_WZ_Untag_TCR", findBinning("L1_MergHP_GGF_WZ_TCR",usePNN), "X_boosted_m", "weight"]
        regions["L1_MergHP_GGF_WZ_Tag_TCR"]=[useData, "Pass_MergHP_GGF_WZ_Untag_TCR", findBinning("L1_MergHP_GGF_WZ_TCR",usePNN), "X_boosted_m", "weight"]
        regions["L1_MergLP_GGF_WZ_Untag_TCR"]=[useData, "Pass_MergLP_GGF_WZ_Untag_TCR", findBinning("L1_MergLP_GGF_WZ_TCR",usePNN), "X_boosted_m", "weight"]
        regions["L1_MergLP_GGF_WZ_Tag_TCR"]=[useData, "Pass_MergLP_GGF_WZ_Untag_TCR", findBinning("L1_MergLP_GGF_WZ_TCR",usePNN), "X_boosted_m", "weight"]
      if useRes:
        regions["L1_Resolved_GGF_WZ_Untag_TCR"]=[useData, "Pass_Resolved_GGF_WZ_Untag_TCR", findBinning("L1_Resolved_GGF_WZ_TCR",usePNN), "X_resolved_WZ_m", "weight"]
        regions["L1_Resolved_GGF_WZ_Tag_TCR"]=[useData, "Pass_Resolved_GGF_WZ_Untag_TCR", findBinning("L1_Resolved_GGF_WZ_TCR",usePNN), "X_resolved_WZ_m", "weight"]
    if useWCR:
      if useMerg:
        regions["L1_MergHP_GGF_WZ_Untag_WCR"]=[useData, "Pass_MergHP_GGF_WZ_Untag_WCR", findBinning("L1_MergHP_GGF_WZ_WCR",usePNN), "X_boosted_m", "weight"]
        regions["L1_MergHP_GGF_WZ_Tag_WCR"]=[useData, "Pass_MergHP_GGF_WZ_Untag_WCR", findBinning("L1_MergHP_GGF_WZ_WCR",usePNN), "X_boosted_m", "weight"]
        regions["L1_MergLP_GGF_WZ_Untag_WCR"]=[useData, "Pass_MergLP_GGF_WZ_Untag_WCR", findBinning("L1_MergLP_GGF_WZ_WCR",usePNN), "X_boosted_m", "weight"]
        regions["L1_MergLP_GGF_WZ_Tag_WCR"]=[useData, "Pass_MergLP_GGF_WZ_Untag_WCR", findBinning("L1_MergLP_GGF_WZ_WCR",usePNN), "X_boosted_m", "weight"]
      if useRes:
        regions["L1_Resolved_GGF_WZ_Untag_WCR"]=[useData, "Pass_Resolved_GGF_WZ_Untag_WCR", findBinning("L1_Resolved_GGF_WZ_WCR",usePNN), "X_resolved_WZ_m", "weight"]
        regions["L1_Resolved_GGF_WZ_Tag_WCR"]=[useData, "Pass_Resolved_GGF_WZ_Untag_WCR", findBinning("L1_Resolved_GGF_WZ_WCR",usePNN), "X_resolved_WZ_m", "weight"]
  if use2L:
    if useSR: 
      if useMerg:
        regions["L2_MergHP_GGF_WZ_SR"]=[useData, "Pass_MergHP_GGF_WZ_SR", findBinning("L2_MergHP_GGF_WZ_SR",usePNN), "X_boosted_m", "weight"]
        regions["L2_MergLP_GGF_WZ_SR"]=[useData, "Pass_MergLP_GGF_WZ_SR", findBinning("L2_MergLP_GGF_WZ_SR",usePNN), "X_boosted_m", "weight"]
      if useRes:
        regions["L2_Resolved_GGF_WZ_SR"]=[useData, "Pass_Resolved_GGF_WZ_SR", findBinning("L2_Resolved_GGF_WZ_SR",usePNN), "X_resolved_WZ_m", "weight"]
    if useZCR:
      if useMerg:
        regions["L2_MergHP_GGF_WZ_ZCR"]=[useData, "Pass_MergHP_GGF_WZ_ZCR", findBinning("L2_MergHP_GGF_WZ_ZCR",usePNN), "X_boosted_m", "weight"]
        regions["L2_MergLP_GGF_WZ_ZCR"]=[useData, "Pass_MergLP_GGF_WZ_ZCR", findBinning("L2_MergLP_GGF_WZ_ZCR",usePNN), "X_boosted_m", "weight"]
      if useRes:
        regions["L2_Resolved_GGF_WZ_ZCR"]=[useData, "Pass_Resolved_GGF_WZ_ZCR", findBinning("L2_Resolved_GGF_WZ_ZCR",usePNN), "X_resolved_WZ_m", "weight"]
